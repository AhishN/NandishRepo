...
public class dbworker extends JFrame {
	...
	public dbworker() {
		...
		textField_2.setBounds(81, 126, 86, 20);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try{
				    ...
				    String sqll="delete from Workaccount where Workerid='"+textField_2.getText()+"' ";
				    PreparedStatement st=con.prepareStatement(sql);
				    PreparedStatement stm=con.prepareStatement(sqll);
				    stm.execute();
				    st.execute();
				    con.close();
				    JOptionPane.showMessageDialog(null, "1 row deleted from worker and workeraccount");}
				}
				catch(Exception l){JOptionPane.showMessageDialog(null,l);}
				refreshtable();}
		});
		...
		button.setBounds(333, 391, 89, 23);
		contentPane.add(button);
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\Kalyanaraman\\OneDrive\\2.png"));
		lblNewLabel.setBounds(0, 0, 766, 425);
